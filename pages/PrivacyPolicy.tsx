...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="pt-32  max-[599px]:pb-10 max-[599px]:pt-20 bg-white text-black min-h-screen  pb-24">
      <div className="container mx-auto px-6 max-w-4xl">
        <span className="text-blue-500 text-4xl max-[599px]:text-2xl font-bold uppercase mb-4 block">DATA INTEGRITY</span>
        <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-16 max-[599px]:mb-6 leading-none">PRIVACY POLICY</h1>
        
        <div className="space-y-12 max-[599px]:space-y-6 font-light text-black/80 leading-relaxed">
          <section className="space-y-4">
            <h2 className="max-[599px]:text-md text-xl font-bold  uppercase border-b border-black pb-2">01. DATA COLLECTION</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="max-[599px]:text-md text-xl font-bold  uppercase border-b border-black pb-2">02. ENCRYPTION STANDARDS</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="max-[599px]:text-md text-xl font-bold  uppercase border-b border-black pb-2">03. THIRD-PARTY DISCLOSURE</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="max-[599px]:text-md text-xl font-bold  uppercase border-b border-black pb-2">04. DATA RETENTION</h2>
            <p>
