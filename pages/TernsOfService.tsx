...
const TermsOfService: React.FC = () => {
  ...
  return (
    <div className="pt-32  max-[599px]:pt-20 max-[599px]:pb-10 bg-white text-black min-h-screen pb-24">
      <div className="container mx-auto px-6 max-w-4xl">
        <span className="text-blue-500 text-4xl max-[599px]:text-2xl font-bold uppercase max-[599px]:mb-2 mb-4 block">LEGAL FRAMEWORK</span>
        <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-16 max-[599px]:mb-6 leading-none">TERMS OF SERVICE</h1>
        
        <div className="space-y-12 max-[599px]:space-y-6 font-light text-black/80 leading-relaxed">
          <section className="space-y-4">
            <h2 className="max-[599px]:text-md text-xl font-bold uppercase border-b border-black pb-2">01. B2B ENGAGEMENT</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="max-[599px]:text-md text-xl font-bold uppercase border-b border-black pb-2">02. TECHNICAL SPECIFICATIONS</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="max-[599px]:text-md text-xl font-bold uppercase border-b border-black pb-2">03. LOGISTICS & DELIVERY</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="max-[599px]:text-md text-xl font-bold uppercase border-b border-black pb-2">04. INTELLECTUAL PROPERTY</h2>
            <p>
          ...
          <div className="pt-12 border-t border-gray-100">
            <p className="text-[10px] font-mono text-black/80 uppercase tracking-widest">
