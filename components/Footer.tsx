...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="glass-dark text-white pt-24 max-[599px]:pt-12 pb-12 border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-white/60">
              <li><Link to="/products" className="text-white/60 hover:text-white transition-colors">Engine Components</Link></li>
              <li><Link to="/products" className="text-white/60 hover:text-white transition-colors">Industrial Filtration</Link></li>
              <li><Link to="/products" className="text-white/60 hover:text-white transition-colors">Screw Compressors</Link></li>
              <li><Link to="/products" className="text-white/60 hover:text-white transition-colors">Heavy Spares</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex gap-3 text-white/60">
                ...
                <a href="tel:+971 0532962420" target="_blank" rel="noopener noreferrer" className="text-sm text-white/60 hover:text-white transition-colors">+971 0532962420</a>
