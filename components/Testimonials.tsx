...
const TestimonialCard: React.FC<{ item: any }> = ({ item }) => (
  <div
    key={item.id}
    className="p-10 max-[599px]:p-6 bg-black/5 shadow-sm border hover:border-blue-500/50 hover:shadow-2xl rounded-md transition-all duration-500 group flex flex-col justify-between h-full"
  >
    <div>
    ...
    <section className="py-32 max-[599px]:py-10 relative overflow-hidden border-t border-white/5">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="mb-20 max-[599px]:mb-6">
          <span className="text-blue-500 text-4xl max-[599px]:text-2xl font-bold uppercase mb-4 max-[599px]:mb-2 block">
            {t.testimonialTitle}
          </span>
        ...
        {/* Desktop/Tablet Grid */}
        <div className="hidden md:grid grid-cols-1 md:grid-cols-3 gap-8 max-[599px]:gap-4">
